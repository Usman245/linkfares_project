            ...
            >
              <div className="grid grid-cols-12">
                <div className="col-span-12 sm:col-span-3 flex justify-center  xs:justify-start xs:items-end">
                  <div>
                    <Image
                      src={airblue} // Corrected here
                      // src={item.airlineimg} // Corrected here
                      width={113}
                      height={56}
                      alt="Airline"
                    />
                ...
                <div className="col-span-12 sm:col-span-6 flex sm:justify-center">
                  <div className="flex flex-col md:flex-row gap-3 justify-center sm:items-center w-full">
                    <div className="flex items-start justify-between sm:flex-col gap-2">
                      <p className="text-xl xl:text-[18px] font-medium text-gray-4B font-semibold">
                        {new Date(item.origintime).toLocaleTimeString([], {
                          hour: '2-digit',
                          minute: '2-digit',
                        })}
                      </p>
                      <p className="font-medium text-base text-gray-4B">
                        {item.originplace} {/* Ensure this field has the city name */}
                      </p>
                    </div>
                    ...
                    <div className="flex flex-row items-start justify-between sm:flex-col gap-2">
                      <p className="text-xl xl:text-[18px] font-medium text-gray-4B font-semibold">
                        {new Date(item.destinationtime).toLocaleTimeString([], {
                          hour: '2-digit',
                          minute: '2-digit',
                        })}
                      </p>
                      <p className="font-medium text-base text-gray-4B">
                        {item.destinationlocation} {/* Ensure this field has the city name */}
                      </p>
                    </div>
                  </div>
                </div>
